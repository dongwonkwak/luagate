...
| `trace_id` | string (32-hex) | NULLABLE | `$luagate_trace_id` | rewrite_by_lua | W3C TraceContext trace ID. 트레이싱 비활성화 또는 미샘플 시 null. [ADR-010](../design/adr/ADR-010-opentelemetry-tracing.md) |
| `span_id` | string (16-hex) | NULLABLE | `$luagate_span_id` | rewrite_by_lua | 루트 span ID. 트레이싱 비활성화 또는 미샘플 시 null. [ADR-010](../design/adr/ADR-010-opentelemetry-tracing.md) |
