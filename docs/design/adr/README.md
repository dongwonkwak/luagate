...
| [ADR-004](./ADR-004-log-metrics-admin-security.md) | 로그/메트릭 + 관리면 보안 | Accepted | 2026-03-13 | 28필드 JSON + Bearer token |
| [ADR-005](./ADR-005-policy-activation-concurrency.md) | 정책 활성화 모델 + 동시성 제어 | Accepted | 2026-03-16 | staged/active 분리 |
...
| ADR-005 | [admin-api.md](../../spec/admin-api.md), [http-pipeline.md](../../spec/http-pipeline.md) |
...
| ADR-009 | [rust-ffi-modules.md](../../spec/rust-ffi-modules.md), [http-pipeline.md](../../spec/http-pipeline.md) |
