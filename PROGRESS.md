...
| 2026-03-20 | DON-209 | MCP 감사 로그 백엔드 통합 — X-MCP 헤더 수신 + spec 갱신 | `lua/luagate/admin/policies.lua`, `lua/luagate/admin/auth.lua`, `lua/luagate/admin/token.lua`, `docs/spec/admin-api.md`, `docs/spec/log-schema.md` | ADR-011 §8 |
