...
| 2026-03-22 | DON-180 | OpenTelemetry 트레이싱 구현 — HTTP 요청 span + OTLP export | `lua/luagate/tracing/`, `conf/luagate.yaml`, `conf/nginx.conf`, `docker-compose.yml`, `Dockerfile`, `docs/spec/log-schema.md` | ADR-010 기반 |
